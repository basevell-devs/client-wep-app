...
const RegisterForm = () => {
    ...
    emailRegister({ email, password })
      .then((response) => {
        registerDatabase({
          ...
          .then(() => setRegisterError("You have registered succesfully. You can login now"))
  ...
  return (
    ...
    //   <Input name="name" register={register} placeholder="Name" error={errors.name} />
    //   {errors.name && <span style={{ color: "red", marginTop: 4, fontSize: 14 }}>{errors.name.message}</span>}
    //   <Input name="surname" register={register} placeholder="Surname" error={errors.surname} />
    //   {errors.surname && <span style={{ color: "red", marginTop: 4, fontSize: 14 }}>{errors.surname.message}</span>}
    ...
    //   By clicking Register, you agree to use out Terms and that you have read our Data Use Policy, including our
    //   Cookie Use
    // </div>
    // </form>
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)} style={{ display: "flex", flexDirection: "column" }}>
        <TextInput name="name" register={register} placeholder="Name" error={errors.name} />
        {errors.name && <span style={{ color: "red", marginTop: 4, fontSize: 14 }}>{errors.name.message}</span>}

        <TextInput name="surname" register={register} placeholder="Surname" error={errors.surname} />
        {errors.surname && <span style={{ color: "red", marginTop: 4, fontSize: 14 }}>{errors.surname.message}</span>}
        ...
        <Button type="submit">Register</Button>
        <span style={{ maxWidth: "260px", textAlign: "justify" }}>
          By clicking Register, you agree to use out Terms and that you have read our Data Use Policy, including our
          Cookie Use
        </span>
      </form>
